...
**HumiAir** is an IoT-based smart humidifier system powered by ESP8266 and Flutter. Monitor real-time room humidity and temperature, control mist production, configure custom thresholds, and view daily usage history from anywhere.
